 ...
 * @author Alexandre
 */
@FacesValidator("validatorEmailForgot")
public class ValidatorEmailForgot implements Validator{
    private static final String BUNDLE_LOCALE = "languagePackage.lang";
    private static final String EMAIL_NOT_EXIST= "emailNotExist";
    private static final String ERROR_EMAIL = "emailNotCorrect";
    ...
    public void validate(FacesContext context, UIComponent component, Object value) throws ValidatorException {
        ...
        if(!Pattern.matches("^[a-zA-Z0-9._-]{2,}@[a-z0-9._-]{2,}\\.[a-z]{2,4}$",email))
            throw new ValidatorException(
                    new FacesMessage(
                            linkToBundle(context).getString(ERROR_EMAIL)));
        if(customerFacade.findByEmail(email) == null)
            throw new ValidatorException(
                    new FacesMessage(
                            linkToBundle(context).getString(EMAIL_NOT_EXIST)));
    }
